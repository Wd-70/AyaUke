    ...
    <div className="text-center mb-8 sm:mb-12">
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold font-display gradient-text">
            노래책
          </h1>
        </div>
        <p className="text-base sm:text-xl text-light-text/70 dark:text-dark-text/70">
      ...
      {mounted && (
        <motion.div
          ...
          className="flex items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-light-text/60 dark:text-dark-text/60"
        >
          {isLoading ? (
